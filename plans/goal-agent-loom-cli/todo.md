...
- [x] Research bunx/npm CLI packaging constraints and record the MVP command scope.
- [x] Refactor the runtime entrypoint so the server can be started from a CLI command without import side effects.
