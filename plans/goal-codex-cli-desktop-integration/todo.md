# Codex CLI/Desktop L3 Todo

## Current todo set

- `research-codex-protocol`: Done. Reconfirmed Codex request/SSE/model expectations and mapped them to current Agent Loom surfaces.
- `codex-request-compat`: Done. Accepted realistic Codex request fields that are safe for text-only bridging.
- `codex-terminal-events`: Done. Emitted Codex-compatible failed/incomplete terminal event details.
- `codex-model-catalog`: Done. Added a Codex-compatible model catalog response and README setup.
