...
Pull requests and pushes to `main` run the CI workflow in `.github/workflows/ci.yml`. The workflow splits validation into static, unit, component, integration, contract, security, and package-smoke jobs, while real Codex E2E runs outside pull request gates.
